...
<div class="fly-header layui-bg-black">
  <div class="layui-container">
    <a class="fly-logo" href="/">
      <img src="/static/res/images/homeWork.png" alt="layui">
    </a>
    ...
    <ul class="layui-nav fly-nav-user">
      ...
      <li class="layui-nav-item">
        <a class="fly-nav-avatar" href="javascript:;">
          <cite class="layui-hide-xs">${currentUser.username }</cite>
          <i class="iconfont icon-renzheng layui-hide-xs" title="${currentUser.username }"></i>
...
<div class="fly-panel fly-column">
  <div class="layui-container">
    ...
    <div class="fly-column-right layui-hide-xs"> 
      ...
      <a href="homeWork/add" target="_blank" class="layui-btn">发表新帖</a> 
    </div> 
...
<div class="fly-footer">
  <p><a href="#" target="_blank">作业管理系统</a> 2019 &copy; <a href="#" target="_blank">XXX 出品</a></p>
