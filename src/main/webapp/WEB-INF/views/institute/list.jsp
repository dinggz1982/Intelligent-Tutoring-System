...
<html>
  ...
  <body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="/homeWork/home">首页</a> <span class="c-gray en">&gt;</span> 学院列表</nav>
<div class="pd-20">
  <div class="cl pd-5 bg-1 bk-gray mt-20">
    <span class="l">
    <a href="#" onclick="addNewSchool()" class="btn btn-primary radius">新增学院</a>
    </span>
  </div>
  <table class="table table-border table-bordered table-hover table-bg table-sort">
    ...
    <tbody>
    	<c:forEach items="${dataList }" var="institute" varStatus="status">
      <tr class="text-c">
        <td><input type="checkbox" value="1" name=""></td>
        <td>${status.index+1 }</td>
        <td><u style="cursor:pointer" class="text-primary">${institute.name }</u></td>
        <td>${institute.school.name }</td>
