...
<style type="text/css">
*{padding:0;margin:0;}
a{text-decoration:none;clear:inherit;}
li{list-style:none;}
.box{width:600px;margin:20px auto;}
.box_l,.box_r{width:240px;height:360px;border:1px solid #ccc;overflow:auto;}
.box_l{float:left;}
...
.box_r{float:right;}
.box_l li,.box_r li{line-height:35px;font-size:14px;padding-left:15px;border-bottom:1px solid #CCCCCC;cursor:pointer}
...
<div style="margin: 0 auto;margin-top: 50px">
   <div style="margin:0 auto;text-align: center;"> <h1>第一步：选择标签</h1></div>
<div class="box">
	<div class="box_l">
		<ul>
			<c:forEach items="${words }" var="word">
				<li><span id="${word.id}">${word.word }</span>
	...
	<div class="box_m">
		<a href="javascript:" id="allleft">取消全部</a>
		<a href="javascript:" id="left">去掉一个</a>
		<a href="javascript:" id="right">选中一个</a>
		<a href="javascript:" id="allright">选中全部</a>
	</div>
...
<div style="clear: both;text-align: center;"><button id="submit" class="button" >提交</button></div>
