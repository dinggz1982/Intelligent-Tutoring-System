...
<head>
    ...
    <meta name="description" content="广州大学,教育技术,网络教育软件设计与开发,丁国柱">
    <meta name="viewport" content="width=device-width">
	<link href='https://fonts.cat.net/css?family=Open+Sans' rel='stylesheet'/>
    <link rel="stylesheet" href="${ctx }/css/bootstrap.min.css" />
    <link rel="stylesheet" href="${ctx }/css/normalize.min.css" />
    <link rel="stylesheet" href="${ctx }/css/font-awesome.min.css"/>
    <link rel="stylesheet" href="${ctx }/css/animate.css"/>
    <link rel="stylesheet" href="${ctx }/css/templatemo_misc.css"/>
...
本应用不支持ie7,请用360、火狐或更高级的ie浏览器！
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-6">
                        <div id="#templatemo_logo">
                            <h2><a href="#" title="网络教育软件设计与开发">网络教育软件设计与开发</a></h2>
                        </div> <!-- /.logo -->
                    </div> <!-- /.col-md-4 -->
    ...
    <script src="${ctx }/js/vendor/jquery-1.10.1.min.js"></script>
